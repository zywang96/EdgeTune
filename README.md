...
- the initial patch is saved under `/your/path/patches_initial/`
- local models are under `/your/path/sequence/local_thetat_{step:02}`
- generated patches are saved under `/your/path/sequence/patches/`
